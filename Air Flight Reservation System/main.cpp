...
class Flight{
	public : 
	   ...
	   void book_a_flight();
	   void cancel_a_flight();
	   void update_reservation();
	   void check_booked_flights();
...
void Flight :: update_reservation()
{
...
void Flight :: check_booked_flights()
{
	int reservation_number;
	cout << "Enter your reservation number: ";
	cin >> reservation_number;
...
void welcome()
{
	...
	std::cout << "\t\t|                                                                  |" << "\n";
	std::cout << "\t\t|          4) CHECK BOOKED FLIGHTS                                 |" << "\n"; 
	std::cout << "\t\t|                                                                  |" << "\n";
	std::cout << "\t\t|          5) GET BOOKING DETAILS                                  |" << "\n"; 
	std::cout << "\t\t|                                                                  |" << "\n";
	std::cout << "\t\t|          6) ABOUT FLIGHT                                         |" << "\n";
	std::cout << "\t\t|                                                                  |" << "\n";
	std::cout << "\t\t|          7) EXIT                                                 |" << "\n"; 
	std::cout << "\t\t|------------------------------------------------------------------|" << "\n";
	...
	do
	{
		...
		{
			case 1:system("CLS");
				flight.book_a_flight();
				break;
			case 2:system("CLS");
				flight.cancel_a_flight();
				break;
			case 3:system("CLS");
				flight.update_reservation();
				break;
			case 4:system("CLS");
				flight.check_booked_flights();
				break;
			case 5:system("CLS");
